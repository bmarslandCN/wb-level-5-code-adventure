...
let enemy4 = sprites.create(img`
    ...
    . . . . . f f . . . f f f . . . 
    `, SpriteKind.Enemy)
enemy4.setPosition(10, 100)
enemy1.follow(food1, 15)
enemy2.follow(food2, 30)
enemy3.follow(food3, 25)
enemy4.follow(food4, 20)
